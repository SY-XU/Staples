...
public class Start extends com.avaya.sce.runtime.Entry {
	...
	public com.avaya.sce.runtime.Submit getSubmit(com.avaya.sce.runtimecommon.SCESession mySession) {
		com.avaya.sce.runtime.Submit submit = new com.avaya.sce.runtime.Submit("HolidayCheck");
		return ( submit );
	}
	/**
	...
	public void initializeVariables(com.avaya.sce.runtimecommon.SCESession session) {
		...
		variableFields = new String[] {
			IProjectVariables.COLLECT_PHONE_NUMBER_FIELD_CONFIDENCE,
			IProjectVariables.COLLECT_PHONE_NUMBER_FIELD_INPUTMODE,
			IProjectVariables.COLLECT_PHONE_NUMBER_FIELD_INTERPRETATION,
			IProjectVariables.COLLECT_PHONE_NUMBER_FIELD_NOINPUTCOUNT,
			IProjectVariables.COLLECT_PHONE_NUMBER_FIELD_NOMATCHCOUNT,
			IProjectVariables.COLLECT_PHONE_NUMBER_FIELD_UTTERANCE,
			IProjectVariables.COLLECT_PHONE_NUMBER_FIELD_VALUE };
		variable = com.avaya.sce.runtime.ComplexVariable.createComplexVariable(IProjectVariables.COLLECT_PHONE_NUMBER, variableFields, null, session, false, false );
		session.putVariable(variable);

		variableFields = new String[] {
			IProjectVariables.POST_NO_MATCH_MENU_FIELD_COLUMN_0,
			IProjectVariables.POST_NO_MATCH_MENU_FIELD_CONFIDENCE,
			IProjectVariables.POST_NO_MATCH_MENU_FIELD_INPUTMODE,
			IProjectVariables.POST_NO_MATCH_MENU_FIELD_INTERPRETATION,
			IProjectVariables.POST_NO_MATCH_MENU_FIELD_NOINPUTCOUNT,
			IProjectVariables.POST_NO_MATCH_MENU_FIELD_NOMATCHCOUNT,
			IProjectVariables.POST_NO_MATCH_MENU_FIELD_UTTERANCE,
			IProjectVariables.POST_NO_MATCH_MENU_FIELD_VALUE };
		variable = com.avaya.sce.runtime.ComplexVariable.createComplexVariable(IProjectVariables.POST_NO_MATCH_MENU, variableFields, null, session, false, false );
		session.putVariable(variable);

		variable = com.avaya.sce.runtime.SimpleVariable.createSimpleVariable(IProjectVariables.PRJ__SIMPLE__PHONE__NUMBER__VALID, "", null, session, false, false );
		session.putVariable(variable);

		variable = com.avaya.sce.runtime.SimpleVariable.createSimpleVariable(IProjectVariables.PRJ__SIMPLE__HOLIDAY, "", null, session, false, false );
		session.putVariable(variable);
		...
		variable = com.avaya.sce.runtime.SimpleVariable.createSimpleVariable(IProjectVariables.PRJ__SIMPLE__PHONE__NUMBER__NOINPUT, "", null, session, false, false );
		session.putVariable(variable);

		variableFields = new String[] {
			IProjectVariables.COLLECT_ACCOUNT_NUMBER_FIELD_CONFIDENCE,
			IProjectVariables.COLLECT_ACCOUNT_NUMBER_FIELD_INPUTMODE,
			IProjectVariables.COLLECT_ACCOUNT_NUMBER_FIELD_INTERPRETATION,
			IProjectVariables.COLLECT_ACCOUNT_NUMBER_FIELD_NOINPUTCOUNT,
			IProjectVariables.COLLECT_ACCOUNT_NUMBER_FIELD_NOMATCHCOUNT,
			IProjectVariables.COLLECT_ACCOUNT_NUMBER_FIELD_UTTERANCE,
			IProjectVariables.COLLECT_ACCOUNT_NUMBER_FIELD_VALUE };
		variable = com.avaya.sce.runtime.ComplexVariable.createComplexVariable(IProjectVariables.COLLECT_ACCOUNT_NUMBER, variableFields, null, session, false, false );
		session.putVariable(variable);
		...
		variable = com.avaya.sce.runtime.SimpleVariable.createSimpleVariable(IProjectVariables.PRJ__SIMPLE__PHONE__NUMBER__INVALID, "", null, session, false, false );
		session.putVariable(variable);

		variableFields = new String[] {
			IProjectVariables.MAIN__MENU_FIELD_COLUMN_0,
			IProjectVariables.MAIN__MENU_FIELD_CONFIDENCE,
			IProjectVariables.MAIN__MENU_FIELD_INPUTMODE,
			IProjectVariables.MAIN__MENU_FIELD_INTERPRETATION,
			IProjectVariables.MAIN__MENU_FIELD_NOINPUTCOUNT,
			IProjectVariables.MAIN__MENU_FIELD_NOMATCHCOUNT,
		...
		variable = com.avaya.sce.runtime.SimpleVariable.createSimpleVariable(IProjectVariables.PRJ__SIMPLE__BUSINESSHOURS, "", null, session, false, false );
		session.putVariable(variable);

		variableFields = new String[] {
			IProjectVariables.PRESENTATION_MENU_FIELD_COLUMN_0,
			IProjectVariables.PRESENTATION_MENU_FIELD_CONFIDENCE,
			IProjectVariables.PRESENTATION_MENU_FIELD_INPUTMODE,
			IProjectVariables.PRESENTATION_MENU_FIELD_INTERPRETATION,
			IProjectVariables.PRESENTATION_MENU_FIELD_NOINPUTCOUNT,
			IProjectVariables.PRESENTATION_MENU_FIELD_NOMATCHCOUNT,
			IProjectVariables.PRESENTATION_MENU_FIELD_UTTERANCE,
			IProjectVariables.PRESENTATION_MENU_FIELD_VALUE };
		variable = com.avaya.sce.runtime.ComplexVariable.createComplexVariable(IProjectVariables.PRESENTATION_MENU, variableFields, null, session, false, false );
		session.putVariable(variable);
