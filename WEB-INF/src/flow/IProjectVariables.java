 ...
 * Last generated by Orchestration Designer at: 2016-DEC-14  11:26:13 AM
 */
public interface IProjectVariables {
	...
	public static final String COLLECT_PHONE_NUMBER = "CollectPhoneNumber";
	public static final String POST_NO_MATCH_MENU = "PostNoMatchMenu";
	public static final String PRJ__SIMPLE__PHONE__NUMBER__VALID = "PRJ_SIMPLE_PHONE_NUMBER_VALID";
	public static final String PRJ__SIMPLE__HOLIDAY = "PRJ_SIMPLE_HOLIDAY";
	public static final String TRANSFER = "Transfer";
	public static final String REDIRECTINFO = "redirectinfo";
	public static final String PRJ__SIMPLE__PHONE__NUMBER__NOINPUT = "PRJ_SIMPLE_PHONE_NUMBER_NOINPUT";
	public static final String COLLECT_ACCOUNT_NUMBER = "CollectAccountNumber";
	public static final String SESSION = "session";
	public static final String PRJ__SIMPLE__PHONE__NUMBER__INVALID = "PRJ_SIMPLE_PHONE_NUMBER_INVALID";
	public static final String MAIN__MENU = "Main_Menu";
	public static final String DD_LAST_EXCEPTION = "ddLastException";
	public static final String PRJ__SIMPLE__BUSINESSHOURS = "PRJ_SIMPLE_BUSINESSHOURS";
	public static final String PRESENTATION_MENU = "PresentationMenu";
	...
	public static final String COLLECT_PHONE_NUMBER_FIELD_CONFIDENCE = "confidence";
	public static final String COLLECT_PHONE_NUMBER_FIELD_INPUTMODE = "inputmode";
	public static final String COLLECT_PHONE_NUMBER_FIELD_INTERPRETATION = "interpretation";
	public static final String COLLECT_PHONE_NUMBER_FIELD_NOINPUTCOUNT = "noinputcount";
	public static final String COLLECT_PHONE_NUMBER_FIELD_NOMATCHCOUNT = "nomatchcount";
	public static final String COLLECT_PHONE_NUMBER_FIELD_UTTERANCE = "utterance";
	public static final String COLLECT_PHONE_NUMBER_FIELD_VALUE = "value";
	public static final String POST_NO_MATCH_MENU_FIELD_COLUMN_0 = "Column0";
	public static final String POST_NO_MATCH_MENU_FIELD_CONFIDENCE = "confidence";
	public static final String POST_NO_MATCH_MENU_FIELD_INPUTMODE = "inputmode";
	public static final String POST_NO_MATCH_MENU_FIELD_INTERPRETATION = "interpretation";
	public static final String POST_NO_MATCH_MENU_FIELD_NOINPUTCOUNT = "noinputcount";
	public static final String POST_NO_MATCH_MENU_FIELD_NOMATCHCOUNT = "nomatchcount";
	public static final String POST_NO_MATCH_MENU_FIELD_UTTERANCE = "utterance";
	public static final String POST_NO_MATCH_MENU_FIELD_VALUE = "value";
	...
	public static final String COLLECT_ACCOUNT_NUMBER_FIELD_CONFIDENCE = "confidence";
	public static final String COLLECT_ACCOUNT_NUMBER_FIELD_INPUTMODE = "inputmode";
	public static final String COLLECT_ACCOUNT_NUMBER_FIELD_INTERPRETATION = "interpretation";
	public static final String COLLECT_ACCOUNT_NUMBER_FIELD_NOINPUTCOUNT = "noinputcount";
	public static final String COLLECT_ACCOUNT_NUMBER_FIELD_NOMATCHCOUNT = "nomatchcount";
	public static final String COLLECT_ACCOUNT_NUMBER_FIELD_UTTERANCE = "utterance";
	public static final String COLLECT_ACCOUNT_NUMBER_FIELD_VALUE = "value";
	...
	public static final String MAIN__MENU_FIELD_COLUMN_0 = "Column0";
	public static final String MAIN__MENU_FIELD_CONFIDENCE = "confidence";
	public static final String MAIN__MENU_FIELD_INPUTMODE = "inputmode";
	public static final String MAIN__MENU_FIELD_INTERPRETATION = "interpretation";
	public static final String MAIN__MENU_FIELD_NOINPUTCOUNT = "noinputcount";
	public static final String MAIN__MENU_FIELD_NOMATCHCOUNT = "nomatchcount";
	...
	public static final String PRESENTATION_MENU_FIELD_COLUMN_0 = "Column0";
	public static final String PRESENTATION_MENU_FIELD_CONFIDENCE = "confidence";
	public static final String PRESENTATION_MENU_FIELD_INPUTMODE = "inputmode";
	public static final String PRESENTATION_MENU_FIELD_INTERPRETATION = "interpretation";
	public static final String PRESENTATION_MENU_FIELD_NOINPUTCOUNT = "noinputcount";
	public static final String PRESENTATION_MENU_FIELD_NOMATCHCOUNT = "nomatchcount";
	public static final String PRESENTATION_MENU_FIELD_UTTERANCE = "utterance";
	public static final String PRESENTATION_MENU_FIELD_VALUE = "value";
