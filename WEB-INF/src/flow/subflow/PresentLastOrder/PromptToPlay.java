package flow.subflow.PresentLastOrder;
 ...
 * Last generated by Orchestration Designer at: 2016-DEC-14  03:00:04 PM
 */
public class PromptToPlay extends com.avaya.sce.runtime.Form {
	...
	public java.util.Collection getPrompts(com.avaya.sce.runtimecommon.SCESession mySession) {
		...
		list.add(new com.avaya.sce.runtime.PromptRefInfo("PresentPrompt", ""));
	...
	public com.avaya.sce.runtime.Submit getSubmit(com.avaya.sce.runtimecommon.SCESession mySession) {
		...
		submit = new com.avaya.sce.runtime.Submit("PresentLastOrder-PostPresentationMenu");
		return submit;
	}
	/**
