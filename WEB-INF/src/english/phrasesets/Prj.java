 ...
 * Class created on: 
 * Last generated by Orchestration Designer at: 2016-DEC-14  12:02:21 PM
 */
public class Prj extends com.avaya.sce.runtime.Phraseset { 
	...
	static {
		...
		// phrase: HolidayPrompt
		com.avaya.sce.runtime.Phraseset.addLocalPhrase(PHRASE_MAP, "HolidayPrompt", "HolidayPrompt.wav", "Its Holiday , Call us Later Time"); 
	...
	public com.avaya.sce.runtime.Phrase getPhrase(String phraseName) {
		return(getPhrase(Prj.PHRASE_MAP, phraseName));
	}
}
